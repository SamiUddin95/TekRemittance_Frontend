...
@Component({
  selector: 'app-transaction-mode-analysis',
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule, PageTitleComponent, NgIconComponent, SsrsReportViewerComponent],
  templateUrl: './transaction-mode-analysis.component.html',
  styleUrls: ['./transaction-mode-analysis.component.scss'],
  providers: [AgentService, provideIcons({ tablerFileReport, tablerSearch, tablerX, tablerPrinter })]
})
export class TransactionModeAnalysisComponent implements OnInit {
  ...
  openReport(): void {
    ...
    this.reportParams = {
      ...
      reportTitle: 'Transaction Mode Analysis Report'
    };
